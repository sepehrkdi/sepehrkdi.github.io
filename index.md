...
thesis — *Machine Unlearning for Model Debiasing* — is a two-institution
collaboration between MaLGa (Machine Learning Genoa Center) and Télécom Paris,
advised by Prof. Vito Paolo Pastore and Prof. Enzo Tartaglione. My research
develops structural machine unlearning: forget-conditioned subnetworks that
...
- **Trustworthy machine learning:** machine unlearning, data privacy
- **Model evaluation:** representation-level model evaluation and auditing
- **Sparsity:** sparsity and lottery-ticket methods
- **Applications:** machine unlearning in federated settings; privacy-critical AI for medical imaging
